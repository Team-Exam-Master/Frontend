...
function History({ historyData }) {
  ...
  return (
    <div className="flex flex-col text-center justify-center">
      ...
      <div
        onClick={() => newChatting()}
        className="flex flex-row  m-2 p-2 rounded cursor-pointer hover:bg-gray-700 group"
      >
      ...
      <div className="overflow-y">
        {histories.map((history) => (
          <div
            ...
            className="flex flex-row m-2 p-2 rounded justify-between items-center cursor-pointer hover:bg-gray-700 transition-all duration-200 ease-in-out ${animate === 'fade-out' ? 'animate-fade-out' : 'animate-fade-in'}`}"
          >
            ...
            >
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-6 hover:scale-125 transition-all duration-300 ease-in-out"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
